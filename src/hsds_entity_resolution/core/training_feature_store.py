    ...
    *,
    ...
    if entity_type == "organization":
        type_specific_columns = (
            ...
            ("NULL", f"{prefix}_ORGANIZATION_ORIGINAL_ID"),
        ...
        type_specific_columns = (
            ...
            (f"{cache_alias}.ORGANIZATION_ORIGINAL_ID", f"{prefix}_ORGANIZATION_ORIGINAL_ID"),
...
def _source_entity_row(
    *,
    ...
    return {
        ...
        "organization_original_id": row.get(f"{prefix}_ORGANIZATION_ORIGINAL_ID"),
...
def _clean_entity_input(*, source_entity: dict[str, Any]) -> RawEntityRowInput:
    ...
    return {
        ...
        "organization_original_id": source_entity.get("organization_original_id"),
